 ...
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |Ctrl/BS |   A  |   R  |   S  |   T  |   D  | RMB  |           |ALTGRP|   H  |   N  |   E  |   I  |   O  |  ' "   |
 * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
...
[BASE] = LAYOUT_gergo(
    ...
    MT(MOD_LCTL, KC_BSPC),  KC_A,  KC_R,   KC_S,   KC_T, KC_D, KC_BTN2,                       KC_RALT,  KC_H,    KC_N, KC_E, KC_I,   KC_O,    KC_QUOT,
    KC_LSFT,                KC_Z,  KC_X,   KC_C,   KC_V, KC_B, KC_BTN1, KC_BTN3,     KC_PGDN, KC_BSPC,  KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
 ...
 */
[SYMB] = LAYOUT_gergo(
    KC_TRNS, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE,                                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,  KC_TRNS,                          KC_TRNS, KC_PLUS, KC_MINS, KC_SLSH, KC_ASTR, KC_PERC, KC_QUOT,
    KC_TRNS, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, KC_TRNS, KC_TRNS,        KC_PGUP, KC_TRNS, KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_SLSH, KC_MINS,
                                        KC_TRNS, KC_TRNS, KC_SCLN, KC_EQL,         KC_EQL,  KC_SCLN, KC_PGUP, KC_DEL
    ),
/* Keymap 2: Pad/Function layer
 *
 * ,-------------------------------------------.                         ,-------------------------------------------.
 * | QWERTY |   1  |  2   |  3   |  4   |  5   |                         |  6   |  7   |  8   |  9   |  0   | PrScr  |
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 ...
 */
[NUMB] = LAYOUT_gergo(
    TO(QWER), KC_1, 	  KC_2,    KC_3,    KC_4,    KC_5,                                                  KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_PSCR,
    KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                             KC_TRNS, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, KC_VOLD, KC_VOLU,
    KC_TRNS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS,         KC_PGUP, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_MPLY, KC_MNXT,
 ...
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |Ctrl/BS |   A  |   S  |   D  |   F  |   G  | RMB  |           |ALTGRP|   H  |   J  |   K  |   L  | ; :  |  ' "   |
 * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
...
[QWER] = LAYOUT_gergo(
    ...
    MT(MOD_LCTL, KC_BSPC),  KC_A,  KC_S,   KC_D,   KC_F, KC_G, KC_BTN2,                       KC_RALT,  KC_H,    KC_J,    KC_K,   KC_L, KC_SCLN, KC_QUOT,
    KC_LSFT,                KC_Z,  KC_X,   KC_C,   KC_V, KC_B, KC_BTN1, KC_BTN3,     KC_PGDN, KC_BSPC,  KC_N,    KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
                         TO(BASE), TO(BASE), LT(SYMB, KC_SPC), LT(NUMB, KC_ESC),     LT(SYMB, KC_ENT), LT(NUMB, KC_SPC), TO(BASE), TO(BASE)
    )
};
